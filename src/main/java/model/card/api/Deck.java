...
public interface Deck extends Iterator<Card> {
    ...
    /**
     * Returns the number of relic cards originally included in the deck at creation.
     * 
    ...
    /**
     * Returns the number of treasure cards originally included in the deck at creation.
     * 
    ...
    /**
     * Returns the number of distinct types of trap cards originally included in the deck at creation.
     * 
    ...
    /**
     * Returns the number of special cards originally included in the deck at creation.
     * 
