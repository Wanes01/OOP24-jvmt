...
/**
 * Utility class for scaling UI elements proportionally based on the window's dimensions.
...
public class GuiScaler {
    ...
    /**
     * Scales both the width and height of the input based on the size of the window.
     * 
