...
class LogicCpuTest {
    ...
    */
     ...
     * In this test the CPU chooses to STAY despite having all relics in the deck drawn.
    */
    @Test
    ...
    */
    ...
    /* 
     * In this test the CPU chooses to STAY despite the amount of gems in the path being high.
    */
    @Test
    ...
    /* 
     * In this test the CPU chooses to STAY despite having 4 relics in the deck drawn.
    */
    @Test
    ...
    */
     ...
     * In this test the CPU chooses to EXIT because 3 traps were drawn and there are 3
